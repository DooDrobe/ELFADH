    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              English Confidence for School & Beyond — From PR Help to Exam Ready.
            </p>
            <p className="text-sm text-gray-400 italic">
              Under Yayasan Pendidikan Elfadh Madani
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-4 text-madani-blue">Contact Us</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-madani-blue">Location</h3>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          &copy; {new Date().getFullYear()} Yayasan Pendidikan Elfadh Madani. All rights reserved.
        </div>
      </div>
    </footer>
  );
